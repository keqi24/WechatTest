...
class Wechat
{
	...
	{
		$this->token = isset($options['token'])?$options['token']:'derektest';
		$this->appid = isset($options['appid'])?$options['appid']:'wx45d04f7dea0c1aff';
		$this->appsecret = isset($options['appsecret'])?$options['appsecret']:'5d43ecd75c6cdb0b1ac3eb2bdcb2abb2';
